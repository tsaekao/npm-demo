...
describe('module: lib/validator/isFinite', function() {
  ...
  describe('qualifiers', function() {
    it('never allows NaN', function() {
      _.forEach(qualifiers, function(qualifier) {
        expect(val.default(NaN, qualifier)).to.equal(false);
      });
    });
  });
  ...
  describe('arguments', function() {
    it('checks for an exact number', function() {
      ...
      expect(val.default(NaN, undefined, {exact: NaN})).to.be.false; // ignored
      expect(val.default(NaN, qualifiers.EXPECTED, {exact: NaN})).to.be.false; // ignored
      expect(val.default(Infinity, undefined, {exact: Infinity})).to.be.false; // ignored
      expect(val.default(-Infinity, undefined, {exact: -Infinity})).to.be.false; // ignored
      expect(val.default(Number.POSITIVE_INFINITY, undefined, {exact: Number.POSITIVE_INFINITY})).to.be.false; // ignored
      expect(val.default(Number.NEGATIVE_INFINITY, undefined, {exact: Number.NEGATIVE_INFINITY})).to.be.false; // ignored
    });
    ...
    it('checks for a minimum number', function() {
      ...
      expect(val.default(7, undefined, {min: '7'})).to.be.true; // ignored
      expect(val.default(7, undefined, {min: NaN})).to.be.true; // ignored
      expect(val.default(-8, undefined, {min: -7})).to.be.false;
      expect(val.default(7, undefined, {min: 8})).to.be.false;
      expect(val.default(7, undefined, {min: Infinity})).to.be.true; // ignored
      expect(val.default(7, undefined, {min: -Infinity})).to.be.true; // ignored
      expect(val.default(7, undefined, {min: Number.POSITIVE_INFINITY})).to.be.true; // ignored
      expect(val.default(7, undefined, {min: Number.NEGATIVE_INFINITY})).to.be.true; // ignored
    });
    ...
    it('checks for a maximum number', function() {
      ...
      expect(val.default(7, undefined, {max: Infinity})).to.be.true; // ignored
      expect(val.default(7, undefined, {max: -Infinity})).to.be.true; // ignored
      expect(val.default(7, undefined, {max: Number.POSITIVE_INFINITY})).to.be.true; // ignored
      expect(val.default(7, undefined, {max: Number.NEGATIVE_INFINITY})).to.be.true; // ignored
    });
