...
import * as val from '../../../src/lib/validator/valWeakSet';

describe('module: lib/validator/valWeakSet', () => {
  describe('validator', () => {
    // module, and value only
    it('#type', () => {
      expect(val.type).toBe(types.WEAK_SET);
    });

    it('succeeds with an RtvSuccess', () => {
      vtu.expectValidatorSuccess(val, new WeakSet());
    });
